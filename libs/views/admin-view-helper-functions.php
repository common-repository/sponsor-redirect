...
class MsbdSRPAdminHelper {
    ...
    public static function render_sidebar() {
        MsbdSRPAdminHelper::render_postbox_open('Micro Solutions Bangladesh');
        MsbdSRPAdminHelper::render_msbd_logos();
        ...
        ?>
            <div class="msbd-logo">
                <a href="http://www.microsolutionsbd.com/" title="Micro Solutions Bangladesh" target="_blank">
                    <img src="<?php echo MSBD_SRP_URL."images/msbd_logo.png"; ?>" alt="msbd logo" />
                </a>
            </div>
