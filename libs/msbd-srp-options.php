...
class MsbdSRPOptions {
    ...
    public function __construct($core) {
        ...
        $this->srp_options_name = $this->core->srp_options_name;
        
        $this->defaults = array(
            'version' => $core->version,
            'msbd_srp_manage_authority' => 'manage_options',
            'srp_share_new_window' => 'yes',
            'srp_rel_nofollow' => 'yes',
            'srp_use_masonary' => 'yes',
        );
    ...
    public function set_to_defaults() {
        delete_option($this->srp_options_name);
    ...
    public function update_options() {            
        ...
        if (isset($_POST['action']) && $_POST['action'] === 'msbd-srp-update-options') {
            
            /*if (!isset($_POST['srp_title'])) { 
                $_POST['srp_title'] = NULL; 
            } else {
                $_POST['srp_title'] = msbd_sanitization($_POST['srp_title'], "text");
            }*/
            ...
            $_POST['action'] = NULL;
            $this->updated = 'msbd-srp-update-options';
    ...
    */
    public function get_option($opt_name = '') {
       ...
       $options = get_option($this->srp_options_name);
    ...
    */
    public function update_option($opt_name, $opt_val = '') {
       ...
       if (is_array($opt_name) && $opt_val == '') {
           ...
           update_option($this->srp_options_name, array_merge($current_options, $new_option));
       }
    }
    ...
    */
    ...
    public function update_messages() {
        if ($this->updated == 'msbd-srp-update-options') {
